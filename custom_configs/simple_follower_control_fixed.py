...
if port_handler.openPort():
    ...
    if port_handler.setBaudRate(1000000):
        ...
        if positions[5] is not None:  # Check if gripper position was read successfully
            ...
            # For write operations, the API seems to return only 2 values, not 3
            comm_result, error = packet_handler.write1ByteTxRx(port_handler, motor_id, 40, 1)  # Address 40 is Torque_Enable
            ...
            if comm_result != scs.COMM_SUCCESS:
                ...
                comm_result, error = packet_handler.write2ByteTxRx(port_handler, motor_id, 42, goal_position)  # Address 42 is Goal_Position
                ...
                comm_result, error = packet_handler.write2ByteTxRx(port_handler, motor_id, 42, current_position)
